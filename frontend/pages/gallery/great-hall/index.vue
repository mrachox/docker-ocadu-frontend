...
import greathallCurrentEvents from '@/components/events/GreatHallCurrentEvents'
import greathallPastEvents from '@/components/events/GreatHallPastEvents'
import axios from 'axios'
export default {
  name: 'galleryGreatHall',
  layout: 'default',
  ...
  methods: {
    getAllPosts() {
      ...
      axios.get(this.ep)
        .then(response => {
          this.posts = response.data.filter(post => post.nid === "100056579")
