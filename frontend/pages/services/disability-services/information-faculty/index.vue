...
import disabilitySlugSubNav from '@/components/subnav/services/DisabilitySlugSubNav'
...
export default {
  ...
  methods: {
    getAllPosts() {
      ...
      axios.get(this.ep)
        .then(response => {
          this.posts = response.data.filter(post => post.nid === "100064993")
