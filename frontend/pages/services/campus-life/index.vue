...
import campuslifeAuxNav from '@/components/feature/CampusLifeAuxNav'
import campuslifeQuicklinks from '@/components/quicklinks/CampusLifeQuicklinks'
import campuslifeSubNav from '@/components/subnav/services/CampusLifeSubNav'
import axios from 'axios'
export default {
  name: 'campuslifeFirstIndex',
  ...
  methods: {
    getAllPosts() {
      ...
      axios.get(this.ep)
        .then(response => {
          this.posts = response.data.filter(post => post.nid === "100064627")
