...
<script>
import hwSlugSubNav from '@/components/subnav/services/HealthWellnessSlugSubNav'
import axios from 'axios'
export default {
  name: 'hwResourcesIndex',
  ...
  methods: {
    getAllPosts() {
      ...
      axios.get(this.ep)
        .then(response => {
          this.posts = response.data.filter(post => post.nid === "100064790")
