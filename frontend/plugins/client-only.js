import Vue from 'vue'
Vue.prototype.$accordionControl = () => {
    var insertbtn = document.createElement("button");
    insertbtn.className = "subnavbtn";
    var top = document.getElementById("top");
    top.insertBefore(insertbtn, top.childNodes[0]);
    var acc = document.getElementsByClassName("subnavbtn");
    var i;
    for (i = 0; i < acc.length; i++) {
        acc[i].innerHTML = "Menu";
...
Vue.prototype.$accessibleAccordion = () => {
    /*
    ...
    accordions.forEach(accordionMenu);
    // console.log(accordions);

    // Accordion-trigger
    // Accordion-panel

    function accordionMenu(accordion) {
