<template>
  <div class="my-4">
      ...
      <p class="text-center"><b-button href="/gallery/ignite-gallery/past-exhibitions" variant="quicklink" target="_blank">MORE PAST EVENTS</b-button></p>
...
export default {
  data () {
    return {
      posts: null,
      ep: 'https://www.ocadu.ca/api/past-ignite-events',
    }
  },
  created() {
    this.getAllPosts();
